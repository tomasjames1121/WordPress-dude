...
*/
          ...
          (k.render = function (a, b, c) {
            ...
            this._onUpdate &&
              (0 > a &&
                ...
                this._startAt.render(a, b, c),
              b ||
                ((this._totalTime !== p || e) && this._callback("onUpdate"))),
              this._cycle !== q &&
                (b ||
                  this._gc ||
            ...
            (j.render = function (a, b, c) {
              ...
              if (
                ...
                for (
                  d = this._first;
                  d &&
                  ((i = d._next), n === this._time && (!this._paused || v));
                ...
                for (
                  d = this._last;
                  d &&
                  ((i = d._prev), n === this._time && (!this._paused || v));
          ...
          p = _gsScope._gsDefine.plugin({
            ...
            set: function (b) {
              ...
              if (this._timeRes) {
                ...
                h =
                  (e + (b - this._s1) / (this._s2 - this._s1)) * this._prec ||
                  0;
              } else
        ...
        function (a, b) {
          ...
          var k,
            ...
            $ = (P.calculateOffset = function (a, b, c) {
              ...
              return (
                a["offset" + d] -
                (Z(a, b, parseFloat(e), e.replace(u, "")) || 0)
              );
            }),
            _ = function (a, b) {
              var c,
            ...
            da = function (a, b, c) {
              ...
              for (c = c || X(a, null); --f > -1; )
                (d -= parseFloat(Y(a, "padding" + e[f], c, !0)) || 0),
                  (d -=
                    parseFloat(Y(a, "border" + e[f] + "Width", c, !0)) || 0);
              return d;
            },
            ea = function (a, b) {
          ...
          var xa,
            ...
            Ma = function (a, b) {
              ...
              if (
                ...
                (h.svg || (a.getBBox && Ka(a))) &&
                  (c &&
                    -1 !== (a.style[za] + "").indexOf("matrix") &&
                    ((d = a.style[za]), (c = 0)),
              ...
              if (
                ...
                if (16 === h.length) {
                  ...
                  n.zOrigin &&
                    ...
                    (n.scaleZ = ((Math.sqrt(E * E + I * I) * q + 0.5) | 0) / q),
                    (n.skewX =
                      C || D
                        ? Math.atan2(C, D) * J + n.rotation
                        : n.skewX || 0),
                    Math.abs(n.skewX) > 90 &&
                      Math.abs(n.skewX) < 270 &&
                      (o
                        ? ((n.scaleX *= -1),
                          (n.skewX += n.rotation <= 0 ? 180 : -180),
                          (n.rotation += n.rotation <= 0 ? 180 : -180))
                        : ((n.scaleY *= -1),
                ...
                parser: function (a, b, c, d, f, h, i) {
                  ...
                  if (
                    ...
                    (l = N.style),
                      ...
                      null != x.xPercent &&
                        (k.xPercent = ga(x.xPercent, j.xPercent)),
                      null != x.yPercent &&
                        (k.yPercent = ga(x.yPercent, j.yPercent));
                    ...
                    if (
                      ...
                      if ("object" == typeof p) for (l in p) x[l] = p[l];
                      else x.rotation = p;
                    "string" == typeof x.x &&
                      -1 !== x.x.indexOf("%") &&
                      ((k.x = 0), (k.xPercent = ga(x.x, j.xPercent))),
                      "string" == typeof x.y &&
                        -1 !== x.y.indexOf("%") &&
                        ((k.y = 0), (k.yPercent = ga(x.y, j.yPercent))),
                      (k.rotation = ha(
                        "rotation" in x
                          ? x.rotation
                          : "shortRotation" in x
                  ...
                  for (
                    Ca &&
                      null != x.force3D &&
                      ((j.force3D = x.force3D), (o = !0)),
                      j.skewType =
                        x.skewType || j.skewType || g.defaultSkewType,
                      n =
                        j.force3D ||
                        j.z ||
                        j.rotationX ||
                        ...
                        k.rotationY ||
                        k.perspective,
                      n || null == x.scale || (k.scaleZ = 1);
                    --w > -1;

                  )
                    (c = ya[w]),
                      (m = k[c] - j[c]),
                      (m > v || -v > m || null != x[c] || null != K[c]) &&
                        ((o = !0),
                  ...
                  return (
                    ...
                    o &&
                      (d._transformType =
                        (j.svg && xa) || (!n && 3 !== this._transformType)
                          ? 2
                          : 3),
                    f
                  );
            ...
            va("backgroundPosition", {
              ...
              parser: function (a, b, c, d, f, g) {
                ...
                if (
                  ...
                  r.split(",").length < 2 &&
                  ((m = Y(a, "backgroundImage").replace(B, "")),
                  m && "none" !== m)
                ) {
                  for (
                    h = q.split(" "),
        ...
        var F = r(
            ...
            function (b, c, d) {
              ...
              (this.vars.immediateRender ||
                ...
                ((this._time = -k), this.render(Math.min(0, -this._delay)));
            },
            !0
          ),
          G = function (b) {
  ...
  jQuery(".button-glitch")
    .on("mouseenter", function () {
      jQuery(this).addClass("button-glitch-active");
      btnGlitch.start();
    })
    .on("mouseleave", function () {
      var $this = jQuery(this);
      if ($this.hasClass("button-glitch-active")) {
        $this.removeClass("button-glitch-active");
        btnGlitch.stop();
      }
    });
});
