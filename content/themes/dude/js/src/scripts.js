...
swup.on("contentReplaced", function () {
  ...
  if (typeof Storage !== "undefined") {
    if (
      sessionStorage.getItem("chat_greeting_visits") >= 1 &&
      sessionStorage.getItem("chat_greeting_sent") === null
    ) {
      // send chat if user has visited over 1 pages and greeting still not sent
      setTimeout(function () {
