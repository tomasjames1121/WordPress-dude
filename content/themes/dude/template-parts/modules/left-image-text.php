 ...
 * @Last Modified time: 2019-06-07 12:39:46
 *
 * @package dude2019
 */
    ...
    <div class="cols">
      <div class="col">
        <div class="image has-lazyload">
          ...
          <div class="background-image full-image"<?php if ( preg_match( '/Windows Phone|Lumia|iPad/i', $_SERVER['HTTP_USER_AGENT'] ) ) : ?> style="background-image: url('<?php echo wp_get_attachment_image_url( $bg_image, 'full' ) ?>');"<?php endif; ?>></div>
