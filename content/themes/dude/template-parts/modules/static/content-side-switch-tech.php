 ...
 * @Last Modified time: 2019-05-25 17:56:59
 *
 * @package dude2019
 */
?>
  ...
  <div class="container">
    ...
    <div class="cols">
      ...
      <div class="col col-switch">
        ...
        <div class="service-switcher">
          <ul id="service-switcher">
            <li><button class="init has-focus clicked" data-tab="verkkosivut" id="init">Verkkosivut</button></li>
      ...
      <div class="col col-content">
        <div class="content visible" data-tab="verkkosivut">
        ...
        <div class="content" data-tab="verkkopalvelut">
          <p>Ilman hyviä verkkosivuja on vähän nolo olla. Sivuilla kävijät odottavat ensiluokkaista kokemusta ja parhaan kokemuksen tarjonnut yritys voittaa.</p>
        ...
        <div class="content" data-tab="integraatiot">
          <p>Ilman hyviä verkkosivuja on vähän nolo olla. Sivuilla kävijät odottavat ensiluokkaista kokemusta ja parhaan kokemuksen tarjonnut yritys voittaa.</p>
