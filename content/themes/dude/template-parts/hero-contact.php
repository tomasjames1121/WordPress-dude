...
<section class="block block-hero block-hero-contact">
  <div class="container">
      ...
      <div class="side-content-box contact-information">
        ...
        40100 Jyväskylä<br />
          ...
          <p class="contact-details">
            ...
            <button class="chat open-chat open-chat-contact" aria-label="Avaa chat" tabindex="0"><?php include get_theme_file_path( '/svg/chat.svg' ); ?>Avaa chat</button>
          </p>
        </div>
    ...
    <div class="featured-image featured-image-side">
      ...
      <div class="background-image preview lazyload" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/dude-map-tiny.jpg');" data-src="<?php echo get_template_directory_uri(); ?>/images/dude-map.jpg" data-src-mobile="<?php echo get_template_directory_uri(); ?>/images/dude-map.jpg"></div>
