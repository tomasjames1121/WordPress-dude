 ...
 * @Last Modified time: 2020-02-12 16:12:14
 *
 * @package dude2019
 */
...
<section class="block block-hero-side-columns block-hero block-hero-frontpage block-hero-enable-transition">
  <div class="container opacity-on-load-instant">
    ...
    <div class="content">
      ...
      <p class="button-wrapper"><a href="#" class="button"><span>Aloitetaanko projekti?</span><?php include get_theme_file_path( '/svg/arrow-right.svg' ); ?></a> <a href="#" class="link link-browse">Selaa tehtyjä töitämme</a></p>
    </div>
