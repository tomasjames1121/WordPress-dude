 ...
 * @Last Modified time: 2019-05-27 00:10:53
 *
 * @package dude2019
 */
...
<section class="block block-hero block-hero-frontpage block-hero-enable-transition">
  <div class="container opacity-on-load-instant">
    ...
    <div class="featured-image featured-image-side">
      ...
      <div class="background-image preview lazyload" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/placeholder-tiny.png');" data-src="<?php echo get_template_directory_uri(); ?>/images/placeholder.png"></div>
