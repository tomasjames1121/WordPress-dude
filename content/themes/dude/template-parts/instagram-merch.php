...
<section class="block block-instagram-merch">
  <div class="container">

    <header class="block-head">
      <h2 class="block-title">#dudekult</h2>
      <p>Tägää sälät Instagramissa hashtagilla <a href="https://www.instagram.com/explore/tags/dudekult/">#dudekult</a> niin homma rokkaa! 🤘</p>
    </header>
