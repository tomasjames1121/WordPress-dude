 ...
 * @Last Modified time: 2019-06-07 13:23:26
 *
 * @package bauermedia
 */
      ...
      <?php foreach ( $related_posts as $related_post ) : ?>
        <div class="col">
          <div class="image has-lazyload">
            <a class="global-link" href="<?php the_permalink() ?>"><span class="screen-reader-text"><?php echo get_the_title( $related_post ) ?></span></a>
